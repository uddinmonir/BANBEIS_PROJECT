...
%%
 ...
 load('G:/RESEARCH/Tanzim/GAN based aerodynamic shape optimization/gan_airfoil_updated_8_AOA_new.mat')
%load('G:/RESEARCH/Tanzim/GAN based aerodynamic shape optimization/gan_airfoil_updated_8_AOA_new.mat');
%load('D:/data/1st_order/dae/index2/NSE3.mat');


% I=speye(size(A1,1));
% PI=I-A2*((A2'*(E1\A2))\(A2'/E1));
% A=PI*A1;E=E1;B=PI*B1;C=C1;
...
%%
low_point =5;      %Lower point of the plotting domain
up_point = 15;       % Higher point of the plotting domain
tot_point = 1000;   
Er= speye(size(Ar,1));
Er_fl= Er;
